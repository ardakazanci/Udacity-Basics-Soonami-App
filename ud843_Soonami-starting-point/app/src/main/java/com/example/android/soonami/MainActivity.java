...
public class MainActivity extends AppCompatActivity {
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        protected void onPostExecute(Event earthquake) {
            if (earthquake == null) { // Boş bir nesne var ise boş dönecektir. Void ' te return demek yeterlidir. 
                return;
            }
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            // İlk olarak URL Boşmu değil mi kontrolü sağlanmalıdır.

            if (url == null) {

                return jsonResponse; // Boş JSONResponse isteği döndürülür.
            ...
            try {
                ...
                // Bağlantı connect ile sağlandıktan sonra yanıtın sonucu kontrol edilmelidir.
            ...
            // Else deyimi açmadık çünkü en lata gelip boş jsonresponse döndürecektir. JSON isteği alamadık çünkü.
        ...
        private Event extractFeatureFromJson(String earthquakeJSON) {
            ...
            if(TextUtils.isEmpty(earthquakeJSON)){ // Eğer http isteği sonucu JSON Yanıtı dönmedi ve boş döndü ise işlem burada kesilecektir.
                return null;
